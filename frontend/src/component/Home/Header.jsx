    ...
    <div className="Header__topbar space__beetween">
      ...
      >
        ...
        >
          ...
          >
            Dobrodošli na naš online shop...Ovde možete naći svoje omiljene čarape...
          </span>
        </div>
      </div>
      ...
      >
        ...
        >
          <strong style={{
            padding:"0px 5px"
          }}>Email:</strong> carape@fashion.com
        </span>
      </div>
    </div>
    {/* Header Navbar */}
    <div className="navbar flex pz__15 space__beetween" ref={switcherTab}>
      <div
      ...
      >
        ...
        >
          ...
          <Link to="/creator">
            <li>Postani prodavac</li>
          </Link>
          <Link to="/faq">
            <li>Korisnička pravila</li>
          </Link>
          <Link to="/contact">
            <li>Kontakt</li>
          </Link>
