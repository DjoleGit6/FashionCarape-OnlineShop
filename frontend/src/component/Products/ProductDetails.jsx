...
const ProductDetails = ({ match, history }) => {
  ...
  const { product, recProducts, loading, error } = useSelector(
    (state) => state.productDetails
  );
  // const {recProductsCF} = useSelector(
  ...
  const reviewSubmitHandler = (e) => {
    ...
    comment.length === 0
      ? toast.error("Molimo vas da popunite polje za komentare")
      : toast.success("Recenzija je uspešno obavljena");
  ...
  const increaseQuantity = () => {
    if (product.Stock <= quantity) return toast.error("Zaliha proizvoda je ograničena");
  ...
  const addToFavouriteHandler = () => {
    ...
    //history.push("/login?redirect=favourites");
    toast.success("Proizvod dodat u Omiljeno");
  };
              ...
              <div className="detailsBlock">
                ...
                <p className="stock__meta" style={{ paddingBottom: ".5vmax" }}>
                  <b className={product.Stock < 1 ? "redColor" : "greenColor"}>
                    {product.Stock < 1 ? "Nije na stanju" : "Na stanju"}
                  </b>
                </p>
                <div
          ...
          <div className="container" id="container">
              <div className="nt-home-by-genre">
                <div className="nt-box">
                  ...
                  <CarouselRec>
                    {recProducts && recProducts.map((product) => (
              ...
              <div className="nt-home-by-genre">
                <div className="nt-box">
                  <div className="nt-box-title">
                    <p>Proizvodi sa sličnim recenzijama</p>
                  </div>

                  <CarouselRec>
                    {recProductsCF && recProductsCF.map((product) => (
                      <ProductCard key={product._id} product={product} />
                    ))}
                  </CarouselRec>
                </div>
